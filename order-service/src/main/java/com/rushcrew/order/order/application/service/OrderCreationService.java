package com.rushcrew.order.order.application.service;
...
import com.rushcrew.order.order.application.exception.StockDepletedException;
import com.rushcrew.order.order.application.port.dto.StockReservationResult;
import com.rushcrew.order.order.application.port.dto.TimeDealInfo;
import com.rushcrew.order.order.application.port.dto.TimeDealStockDetail;
import com.rushcrew.order.order.application.validator.OrderItemValidator;
import com.rushcrew.order.order.application.validator.PurchaseLimitValidator;
import com.rushcrew.order.order.application.validator.QueueTokenValidator;
import com.rushcrew.order.order.application.validator.TimeDealStockValidator;
import com.rushcrew.order.order.application.validator.TimeDealValidator;
import com.rushcrew.order.order.domain.entity.Order;
import com.rushcrew.order.order.domain.entity.OrderItem;
import com.rushcrew.order.order.domain.entity.OrderReservation;
import com.rushcrew.order.order.domain.repository.OrderRepository;
import com.rushcrew.order.order.domain.vo.ProductSnapshot;
import com.rushcrew.order.order.application.port.out.QueuePort;
import com.rushcrew.order.order.application.port.out.TimeDealStockPort;
import com.rushcrew.order.order.application.port.out.OrderEventPort;
