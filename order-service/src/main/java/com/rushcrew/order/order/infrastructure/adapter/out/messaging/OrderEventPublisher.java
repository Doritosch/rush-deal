package com.rushcrew.order.order.infrastructure.adapter.out.messaging;
...
import com.rushcrew.order.order.infrastructure.adapter.out.messaging.event.StockDepletedEvent;
