package com.rushcrew.order.order.domain.entity;
...
import com.rushcrew.order.order.domain.enums.OrderEventType;
import com.rushcrew.order.order.domain.enums.OrderStatus;
import com.rushcrew.order.order.domain.vo.OrderAmount;
import com.rushcrew.order.order.domain.vo.ShippingInfo;
