...
public interface TimeDealStockPort {
	...
	TimeDealInfo getTimeDeal(UUID timeDealId);
	...
	void confirmStock(UUID timeDealStockId, Integer quantity, UUID orderId);

	// 재고 복구 (예약 해제)
	void restoreStock(UUID timeDealStockId, Integer quantity, UUID orderId, String reason);
}
